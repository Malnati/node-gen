...
const EXTRA_DBS = [
  { name: 'todo', dbName: 'todo_mock', schemaFile: 'todo/db/schema.postgres.ddl', checkTable: 'tb_simple_item' },
  { name: 'selling', dbName: 'selling_mock', schemaFile: 'selling/db/schema.postgres.ddl', checkTable: 'tb_customer' },
  { name: 'schedule', dbName: 'schedule_mock', schemaFile: 'schedule/db/schema.postgres.ddl', checkTable: 'tb_resource' },
];
