-- test/e2e-generator-mock/projects/selling/db/database.mysql.sql
...
('Cliente A','a@example.com',1000.00,1),('Cliente B','b@example.com',2000.00,1),('Cliente C','c@example.com',3000.00,1);
...
(1,'Rua 1','Cidade A','SP',1),(2,'Rua 2','Cidade B','RJ',1);
