-- test/e2e-generator-mock/projects/schedule/db/schema.sqlserver.ddl
-- Modelo de agendamento em T-SQL: auto-referência, N-N com role, histórico com NVARCHAR(MAX) para JSON.
