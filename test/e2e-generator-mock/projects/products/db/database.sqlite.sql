-- test/e2e-generator-mock/projects/products/db/database.sqlite.sql
...
('d1eebc99-9c0b-4ef8-bb6d-6bb9bd380a11','a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a11','e1eebc99-9c0b-4ef8-bb6d-6bb9bd380a11','SKU-001','Produto Alfa','Descrição fictícia do produto Alfa.',(SELECT id FROM unit_of_measure WHERE code='UN' LIMIT 1),(SELECT id FROM currency WHERE code='BRL' LIMIT 1),29.90),
('d1eebc99-9c0b-4ef8-bb6d-6bb9bd380a12','a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a11','e1eebc99-9c0b-4ef8-bb6d-6bb9bd380a12','SKU-002','Produto Beta','Descrição fictícia do produto Beta.',(SELECT id FROM unit_of_measure WHERE code='UN' LIMIT 1),(SELECT id FROM currency WHERE code='BRL' LIMIT 1),45.00),
('d1eebc99-9c0b-4ef8-bb6d-6bb9bd380a13','a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a12','e1eebc99-9c0b-4ef8-bb6d-6bb9bd380a13','SKU-003','Produto Gama',NULL,(SELECT id FROM unit_of_measure WHERE code='UN' LIMIT 1),(SELECT id FROM currency WHERE code='BRL' LIMIT 1),99.00);
