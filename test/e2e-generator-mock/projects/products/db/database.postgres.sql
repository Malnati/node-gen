-- test/e2e-generator-mock/projects/products/db/database.postgres.sql
...
INSERT INTO product (external_id, tenant, account_id, sku, name, description, unit_of_measure_id, currency_id, unit_price)
SELECT 'd1eebc99-9c0b-4ef8-bb6d-6bb9bd380a11','a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a11','e1eebc99-9c0b-4ef8-bb6d-6bb9bd380a11','SKU-001','Produto Alfa','Descrição fictícia do produto Alfa.',u.id,c.id,29.90
FROM unit_of_measure u, currency c WHERE u.code='UN' AND c.code='BRL';
INSERT INTO product (external_id, tenant, account_id, sku, name, description, unit_of_measure_id, currency_id, unit_price)
SELECT 'd1eebc99-9c0b-4ef8-bb6d-6bb9bd380a12','a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a11','e1eebc99-9c0b-4ef8-bb6d-6bb9bd380a12','SKU-002','Produto Beta','Descrição fictícia do produto Beta.',u.id,c.id,45.00
FROM unit_of_measure u, currency c WHERE u.code='UN' AND c.code='BRL';
INSERT INTO product (external_id, tenant, account_id, sku, name, description, unit_of_measure_id, currency_id, unit_price)
SELECT 'd1eebc99-9c0b-4ef8-bb6d-6bb9bd380a13','a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a12','e1eebc99-9c0b-4ef8-bb6d-6bb9bd380a13','SKU-003','Produto Gama',NULL,u.id,c.id,99.00
FROM unit_of_measure u, currency c WHERE u.code='UN' AND c.code='BRL';
