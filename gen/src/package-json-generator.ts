  ...
  generatePackageJsonFile() {
      ...
      const packageJsonContent = {
        ...
        scripts: {
          ...
          "start:dev": "node -e \"try{require('fs').rmSync('dist',{recursive:true,force:true})}catch(e){}\" && npx nest start --watch --verbose",
          "start:debug": "npx nest start --debug --watch",
          "start:prod": "node dist/main",
          lint: "eslint '{src,apps,libs,test}/**/*.ts' --fix",
          test: "node -e \"try{require('fs').rmSync('dist',{recursive:true,force:true})}catch(e){}\" && jest --clearCache && jest --detectOpenHandles",
