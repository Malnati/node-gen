...
- `test/e2e-generator/run.js` — Build obrigatório; verificação de subida da API (porta, /health, logs); main async; leitura de PORT do .env sem capturar DATABASE_PORT.
...
- `test/e2e-generator/README.md` — Menção à verificação de API e /health.
